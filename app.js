...
const { getNasaImageOfTheDay } = require('./api/nasaApi');
...
app.get('/blog', async (req, res) => {
  try {
    const apiKey = '22XZditDDamApXywadr6vGgGBBQ5lOxyZXGcJvNN';
    const imageData = await getNasaImageOfTheDay(apiKey);

    res.render('blog', { imageData });
  } catch (error) {
